...
- **Steel Experiment – Bouwplaats Course**  
  Guided students through assignments on bolted steel connections (Eurocode 3) and tensile test data analysis.  
...
:class: dropdown, note
FlexDelft is a staffing agency in Delft that connects TU Delft students with flexible part-time jobs, with a strong focus on teaching assistant (TA) roles. They offer opportunities to support education by assisting in courses, labs, and tutorials across various faculties. FlexDelft works closely with the university to match students with TA positions that fit their studies and schedules
```
