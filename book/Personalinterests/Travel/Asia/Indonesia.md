...
<div style="display: flex; justify-content: space-around;">
  <figure style="text-align: center; width: 50%;">
    <img src="Figures/Indonesia_Family.JPG" alt="fam" style="width: 100%;">
    <figcaption></figcaption>
  </figure>
  <figure style="text-align: center; width: 25%;">
    <img src="Figures/Indonesia_Temple.JPG" alt="temp1" style="width: 100%;">
    <figcaption></figcaption>
  </figure>
  <figure style="text-align: center; width: 25%;">
    <img src="Figures/Indonesia_templefam.JPG" alt="temp2" style="width: 100%;">
    <figcaption></figcaption>
  </figure>
</div>
...
<div style="display: flex; justify-content: space-around;">
  <figure style="text-align: center; width: 30%;">
    <img src="Figures/Indonesia_Turtles.JPG" alt="turtlebucket" style="width: 100%;">
    <figcaption>Me with a bucket of mini turtles</figcaption>
  </figure>
  <figure style="text-align: center; width: 30%;">
    <img src="Figures/Indonesia_Turtlebeach.JPG" alt="turtlesea" style="width: 100%;">
...
<div style="display: flex; justify-content: space-around;">
  <figure style="text-align: center; width: 33%;">
    <img src="Figures/Indonesia_monkeys.JPG" alt="monkey" style="width: 100%;">
    <figcaption>Monkeys</figcaption>
  </figure>
  <figure style="text-align: center; width: 33%;">
    <img src="Figures/Indonesia_Sulfurmountain.JPG" alt="sulfur" style="width: 100%;">
    <figcaption>Mount Ijen</figcaption>
  </figure>
  <figure style="text-align: center; width: 33%;">
    <img src="Figures/Indonesia_Resort.JPG" alt="resort" style="width: 100%;">
