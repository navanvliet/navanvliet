...
<div style="display: flex; justify-content: space-around;">
  <figure style="text-align: center; width: 30%;">
    <img src="Figures/Malaysia_PetronasTowers.JPG" alt="petronastowers" style="width: 100%;">
    <figcaption>Petronas Towers</figcaption>
  </figure>
  <figure style="text-align: center; width: 30%;">
    <img src="Figures/Malaysia_Fishfoot.JPG" alt="fishfoot" style="width: 100%;">
...
<div style="display: flex; justify-content: space-around;">
  <figure style="text-align: center; width: 30%;">
    <img src="Figures/Malaysia_Beach.JPG" alt="beach" style="width: 100%;">
    <figcaption>Beach at resort</figcaption>
  </figure>
  <figure style="text-align: center; width: 30%;">
    <img src="Figures/Malaysia_Sailing.JPG" alt="sailing" style="width: 100%;">
